...
PATH_PREFIX := $(shell grealpath $(TREMO_SDK_PATH) --relative-to=.)/
SRC_PATH := $(foreach src, $($(PROJECT)_SOURCE),'$(addprefix $(PATH_PREFIX),$(shell grealpath $(src) --relative-to=$(TREMO_SDK_PATH)))'$(comma))
LIB_PATH := $(foreach lib, $($(PROJECT)_LIBS),'$(addprefix $(PATH_PREFIX),$(shell grealpath $(lib) --relative-to=$(TREMO_SDK_PATH)))'$(comma))
INC_PATH := $(foreach inc, $($(PROJECT)_INC_PATH),$(addprefix $(PATH_PREFIX),$(shell grealpath $(inc) --relative-to=$(TREMO_SDK_PATH)))$(semi))
